                            ...
                            <div class="btn-buyAll">
                                <?php
                                    ...
                                    if ($result->num_rows > 0) {
                                        echo '<button class="btn-checkout" role="button" type="submit">Checkout</button>';
                                    }
                                    
                                    else {
                                        echo '<button disabled class="btn btn-danger btn-checkout" role="button" type="submit">Checkout</button>';
                                    }
