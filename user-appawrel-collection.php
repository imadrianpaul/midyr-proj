<?php
    ...
    $products_appawrel = get_products_by_type('Appawrel');
?>
...
<head>
    ...
    <title>Skywrath | FPS Items</title>
</head>
<body>
    <div class="main-container user-boom-collection">
        ...
        <div class="bc-content">
            <h3>Top FPS Game Items!</h3>
            <div class="container-fluid">
                <div class="row">
                    <?php while($row = mysqli_fetch_array($products_appawrel)){ ?>
                        <div class="col-md-4">
