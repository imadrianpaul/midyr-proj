...
<body>
    <div class="main-container custom-page">
        ...
        <div class="custom-content">
            <h1>Notify us the latest games!</h1>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5">
                        <div class="custom-item-img">
                            <img src="css/images/shop-item-collections/custom.png" alt="Image">
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="custom-description">
                            <p><span style="color:#bf4c41">Skywrath</span> Please read the instructions carefully! Skywrath is an online game purchasing system that consists of the popular games and the game items itself. If you have a suggestion on what games should we add, contact us through inputting your e-mail in the Home Page below. </p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="reminder">
                            <h5>Please read before deciding to order!</h5>
                            <ol>
                                <li>Once your request has been received, a representative will assess it and you will receive your quotation, along with purchase and payment instructions, by email within 24 to 48 hours.</li>
                                <li>Do not forget to place an order and provide the relevant information if you wish to proceed with the transaction.</li>
                            </ol>
                        </div>
                    </div>
                </div>
